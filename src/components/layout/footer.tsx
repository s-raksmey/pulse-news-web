              ...
              <Link href="/" className="inline-block group">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Breaking News, Real Time</p>
                  </div>
                </div>
              </Link>
              ...
              <div className="flex space-x-4">
                {[
                  ...
                  <a 
                    ...
                    className={`w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center transition-colors duration-200 ${social.color} hover:text-white`}
                  >
                    <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24" className="text-gray-600">
                      <path d={social.icon}/>
                    </svg>
                  </a>
                ))}
          ...
          <div className="mx-auto max-w-6xl px-6 py-6">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              ...
              <div className="flex items-center space-x-6 text-gray-500 text-sm">
                ...
                <Link href="/cookies" className="hover:text-gray-900 transition-colors duration-200">Cookies</Link>
              </div>
            </div>
          </div>
        </div>
